...
class _S extends ConsumerState<SearchScreen>{
  ...
  Map? _res; bool _loading=false; String? _err;
  Future<void> _search() async { if(_c.text.trim().isEmpty) return; setState((){ _loading=true; _err=null;}); try{ _res=await YtRemote().search(_c.text.trim());}catch(e){ _err=e.toString();} setState(()=>_loading=false); }
